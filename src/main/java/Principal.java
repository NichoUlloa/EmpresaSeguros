public class Principal {
    ...
    public void inicializar() {
        ...
        empresa.agregarCliente(new Cliente("Francisco Poblete", "Juan Perez", 20, "11.111.111-1", 12345678, "Chileno"));

        empresa.agregarCliente(new Cliente("los avellanos", "Pedro Perez", 20, "11.111.111-1", 23456789, "Chileno"));
        empresa.agregarCliente(new Cliente("las quilas", "Nicolas Ulloa", 72, "22.222.222-2", 34567890, "Chileno"));
        Cliente cliente = new Cliente("las quilas", "Juan Barria", 68, "33.333.333-3", 45678912, "Chileno");
        ...
        Vendedor vendedor = new Vendedor(2,"Juan Loyola", 22,"44.444.444-4", 12345678, "Chileno");
        empresa.agregarVendedor(vendedor);
        empresa.agregarVendedor(new Vendedor(3,"Pedro Loyola", 22,"55.555.555-5", 23456789, "Chileno"));
        empresa.agregarVendedor(new Vendedor(4,"Nicolas Loyola", 33,"66.666.666-6", 34567890, "Chileno"));
